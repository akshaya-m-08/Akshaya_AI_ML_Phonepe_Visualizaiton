...
map_trans['User_District'] = map_trans['User_District'].str.replace('district', ' ').str.title().str.strip()
map_user['State'] = map_user['State'].str.replace('-', ' ').str.title()
map_user['User_District'] = map_user['User_District'].str.replace('district', ' ').str.title().str.strip()
map_ins['State'] = map_ins['State'].str.replace('-', ' ').str.title()
map_ins['User_District'] = map_ins['User_District'].str.replace('district', ' ').str.title().str.strip()
top_trans['State'] = top_trans['State'].str.replace('-', ' ').str.title()
top_user['State'] = top_trans['State'].str.replace('-', ' ').str.title()
top_ins['State'] = top_ins['State'].str.replace('-', ' ').str.title()
top_user.loc[8924, 'State'] = 'West Bengal'
